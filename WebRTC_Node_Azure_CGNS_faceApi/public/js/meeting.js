  ...
  */
    function joinRoom(name) {
        ...
        $("#btnCheckScore").click(function() {
            ...
            var rtcserver = "domain";
            var image1 = ""; // this is the snapshot
            var image2 = "2nd_image_url";
          
            var subscribKey = 'azure_face_key';
            ...
            var snapshot = function () {
               ...
               // console.log(base64);
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.status == "ok") {
                            image1 = rtcserver + data.filename;
                            debug(image1);
                                            ...
                                            compareFace(face1,
                                                ...
                                                function(r) {
                                                    ...
                                                    if (json.confidence > 0.5) {
                                                        $("#lblValidResult").val("VALID");
                                                        $("#lblValidResult").removeClass("label label-success").addClass("label label-success");
                                                    } else {
                                                        $("#lblValidResult").val("INVALID");
                                                        $("#lblValidResult").removeClass("label label-danger").addClass("label label-danger");
                                                    }
                                                });
                                        });
                                });
    ...
    function createOffer(participantId) {
        ...
        _sendChannel[participantId].onerror = function (e) {
            console.error(e);
        };
    ...
    function handleRemoteStreamAdded(from) {
        return function (event) {
            console.log('Remote stream start add');
    ...
    function setLocalDescriptionSuccess() { console.log("setLocalDescriptionSuccess .")  }

    function setRemoteDescriptionSuccess() { console.log("setRemoteDescriptionSuccess .")  }

    function addIceCandidateSuccess() { console.log("addIceCandidateSuccess.") }
    ...
    function gotReceiveChannel(id) {
        return function (event) {
            ...
            //_sendChannel[id].ondatachannel = handleReceiveChannelStateChange(id);
        }
    }
    ...
    function addIceCandidateError(error) { console.error("LL::add ice candidate error!!!!"); console.log(error); }
